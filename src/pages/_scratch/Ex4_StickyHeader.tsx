...
export function Ex4_StickyHeader() {
  return (
    <div>
      <div className='overflow-hidden rounded-md border bg-background [&>div]:max-h-96'>
        <Table className='border-separate border-spacing-0 [&_td]:border-border [&_tfoot_td]:border-t [&_th]:border-b [&_th]:border-border [&_tr]:border-none [&_tr:not(:last-child)_td]:border-b'>
          <TableHeader className='sticky top-0 z-10 bg-background backdrop-blur-xs'>
