...
export function Ex3_DenseTable() {
  return (
    <div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/50">
              ...
              <TableHead className="py-2">Typing</TableHead>
              <TableHead className="py-2">Paradigm</TableHead>
              <TableHead className="py-2">Extension</TableHead>
              <TableHead className="py-2">Latest Version</TableHead>
              <TableHead className="py-2">Popularity</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
