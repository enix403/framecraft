...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-framecraft-gray-dark py-10 text-white">
      <div className="px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-md bg-framecraft-blue flex items-center justify-center text-white font-bold">
                FC
              </div>
              <span className="text-xl font-bold">FrameCraft</span>
            </div>
            <p className="text-gray-400">
              AI-powered floor plan generation for architects, designers, and homeowners.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#workflow" className="text-gray-400 hover:text-white transition-colors">How It Works</a></li>
        ...
        <div className="mt-10 border-t border-gray-700 pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">© 2025 FrameCraft. All rights reserved.</p>
